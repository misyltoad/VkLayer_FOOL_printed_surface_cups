...
namespace vkroots {
  ...
  public:
    ...
    CreatePrintedSurfaceFOOL = (PFN_vkCreatePrintedSurfaceFOOL) NextGetPhysicalDeviceProcAddr(instance, "vkCreatePrintedSurfaceFOOL");
    ...
    EnumeratePrintersFOOL = (PFN_vkEnumeratePrintersFOOL) NextGetPhysicalDeviceProcAddr(instance, "vkEnumeratePrintersFOOL");
    ...
    GetPrinterPropertiesFOOL = (PFN_vkGetPrinterPropertiesFOOL) NextGetPhysicalDeviceProcAddr(instance, "vkGetPrinterPropertiesFOOL");
    ...
    PFN_vkCreatePrintedSurfaceFOOL CreatePrintedSurfaceFOOL;
    ...
    PFN_vkEnumeratePrintersFOOL EnumeratePrintersFOOL;
    ...
    PFN_vkGetPrinterPropertiesFOOL GetPrinterPropertiesFOOL;
  ...
  template <typename InstanceOverrides, typename PhysicalDeviceOverrides, typename DeviceOverrides>
  static VkResult wrap_CreatePrintedSurfaceFOOL(VkPhysicalDevice physicalDevice, const VkPrintedSurfaceCreateInfoFOOL *pCreateInfo, const VkAllocationCallbacks *pAllocator, VkSurfaceKHR *pSurface) {
    const VkPhysicalDeviceDispatch* dispatch = tables::LookupPhysicalDeviceDispatch(physicalDevice);
    VkResult ret = PhysicalDeviceOverrides::CreatePrintedSurfaceFOOL(dispatch, physicalDevice, pCreateInfo, pAllocator, pSurface);
    return ret;
  }
  template <typename InstanceOverrides, typename PhysicalDeviceOverrides, typename DeviceOverrides>
  ...
  template <typename InstanceOverrides, typename PhysicalDeviceOverrides, typename DeviceOverrides>
  static VkResult wrap_EnumeratePrintersFOOL(VkPhysicalDevice physicalDevice, uint32_t *pPrinterCount, VkPrinterFOOL *pPrinters) {
    const VkPhysicalDeviceDispatch* dispatch = tables::LookupPhysicalDeviceDispatch(physicalDevice);
    VkResult ret = PhysicalDeviceOverrides::EnumeratePrintersFOOL(dispatch, physicalDevice, pPrinterCount, pPrinters);
    return ret;
  }
  template <typename InstanceOverrides, typename PhysicalDeviceOverrides, typename DeviceOverrides>
  ...
  template <typename InstanceOverrides, typename PhysicalDeviceOverrides, typename DeviceOverrides>
  static void wrap_GetPrinterPropertiesFOOL(VkPhysicalDevice physicalDevice, VkPrinterFOOL printer, VkPrinterPropertiesFOOL *pProperties) {
    const VkPhysicalDeviceDispatch* dispatch = tables::LookupPhysicalDeviceDispatch(physicalDevice);
    PhysicalDeviceOverrides::GetPrinterPropertiesFOOL(dispatch, physicalDevice, printer, pProperties);
  }
  template <typename InstanceOverrides, typename PhysicalDeviceOverrides, typename DeviceOverrides>
  ...
  static PFN_vkVoidFunction GetPhysicalDeviceProcAddr(VkInstance instance, const char* name) {
    ...
    constexpr bool HasCreatePrintedSurfaceFOOL = requires(const PhysicalDeviceOverrides& t) { &PhysicalDeviceOverrides::CreatePrintedSurfaceFOOL; };
    if constexpr (HasCreatePrintedSurfaceFOOL) {
      if (!std::strcmp("vkCreatePrintedSurfaceFOOL", name))
        return (PFN_vkVoidFunction) &wrap_CreatePrintedSurfaceFOOL<InstanceOverrides, PhysicalDeviceOverrides, DeviceOverrides>;
    }
    ...
    constexpr bool HasEnumeratePrintersFOOL = requires(const PhysicalDeviceOverrides& t) { &PhysicalDeviceOverrides::EnumeratePrintersFOOL; };
    if constexpr (HasEnumeratePrintersFOOL) {
      if (!std::strcmp("vkEnumeratePrintersFOOL", name))
        return (PFN_vkVoidFunction) &wrap_EnumeratePrintersFOOL<InstanceOverrides, PhysicalDeviceOverrides, DeviceOverrides>;
    }
    ...
    constexpr bool HasGetPrinterPropertiesFOOL = requires(const PhysicalDeviceOverrides& t) { &PhysicalDeviceOverrides::GetPrinterPropertiesFOOL; };
    if constexpr (HasGetPrinterPropertiesFOOL) {
      if (!std::strcmp("vkGetPrinterPropertiesFOOL", name))
        return (PFN_vkVoidFunction) &wrap_GetPrinterPropertiesFOOL<InstanceOverrides, PhysicalDeviceOverrides, DeviceOverrides>;
    }
